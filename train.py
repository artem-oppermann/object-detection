...
def main(_argv):
    ...
    # train_dataset: ((None, 416, 416, 3), ((None, 13, 13, 3, 6), (None, 26, 26, 3, 6), (None, 52, 52, 3, 6)))
    ...
    if FLAGS.mode == 'eager_tf':
        ...
        for epoch in range(1, FLAGS.epochs + 1):
            for batch, (images, labels) in enumerate(train_dataset):
                ...
                with tf.GradientTape() as tape:
                    ...
                    #outputs[0].shape: (1, 13, 13, 3, 85)
                    #outputs[1].shape: (1, 26, 26, 3, 85)
                    #outputs[2].shape: (1, 52, 52, 3, 85)
            ...
            model.save_weights(
                'checkpoints/voc2012/voc2012_train_{}.tf'.format(epoch))
    else:
        ...
        callbacks = [
            ...
            ModelCheckpoint('checkpoints/voc2012/voc2012_train_{epoch}.tf',
