...
flags.DEFINE_string('classes', './data/class_names/coco.names', 'path to classes file')
...
def main(_argv):
    ...
    if FLAGS.tfrecord:
        dataset = load_tfrecord_dataset(
            FLAGS.tfrecord, FLAGS.classes, FLAGS.image_size)
    ...
    img = transform_images(img, FLAGS.image_size)
